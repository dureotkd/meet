...
<body>
  ...
  <path d="M19 12H5M12 19l-7-7 7-7"/>
    ...
    <div class="logo">FRINED FOLDER</div>
    ...
    <div class="main-container">
      <div class="profile">
        <div class="profile-avatar">
          <img src="/file/showImg?id=${loginedMember.extra.file__common__attachment['1'].id}&updateDate=${loginedMember.extra.file__common__attachment['1'].updateDate}" alt="" class="profile-img">
          ...
          <div class="intro box">
            ...
            <div class="info">
              <div class="info-item">
                ...
                My Job is a<a href="#">DeveloPer</a>
              </div>
              <div class="info-item">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                  <path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z" />
        ...
        <div class="timeline-right">
          <div class="status box">
            ...
            <div class="status-main">
              <img class="status-img" src="/file/showImg?id=${loginedMember.extra.file__common__attachment['1'].id}&updateDate=${loginedMember.extra.file__common__attachment['1'].updateDate}" alt="" class="profile-img">
          	  <textarea class="status-textarea" placeholder="현재 상황은 이렇습니다"></textarea>
            </div>
          ...
          <div class="album box">
            <div class="status-main">
              ...
              <div class="album-detail">
                <div class="album-title"><strong>${loginedMember.nickname}</strong> create new <span>album</span></div>
  ...
  <div class="right-side" :class="{ 'active': rightSide }">
    <div class="account">
      ...
      ${loginedMember.nickname}
        <img class="account-profile" src="/file/showImg?id=${loginedMember.extra.file__common__attachment['1'].id}&updateDate=${loginedMember.extra.file__common__attachment['1'].updateDate}" alt="" class="profile-img">
 		<span>▼</span>
      </span>
    </div>
    <div class="side-wrapper stories">
      <div class="side-title">STORY</div>
      <div class="user">
    ...
    <div class="side-wrapper contacts">
      <div class="side-title">MESSAGE</div>
      <div class="user">
