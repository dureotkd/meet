...
<div class="slider">
   ...
   <div><img class="img-slide" src="${article.extra.articleImgUrl}" alt="" /></div>
   </c:forEach>
  </div>
</div>
<div class="login-form-box">
	<form action="doJoin" method="POST" class="login-form"
		...
		<div class="file-con">
		<label for="ex_file"><img id="img" class="file-upload" src="https://scontent-cph2-1.cdninstagram.com/v/t51.2885-19/44884218_345707102882519_2446069589734326272_n.jpg?_nc_ht=scontent-cph2-1.cdninstagram.com&_nc_ohc=7xEzH-b7neEAX8-u4aK&oh=03aa0383a46332fd1b76eaa62a308799&oe=5F72988F&ig_cache_key=YW5vbnltb3VzX3Byb2ZpbGVfcGlj.2" alt="" /></label>
		</div>
		<input type="file" id="ex_file" class="login-input-box" placeholder="프로필" accept="image/*" name="file__member__0__common__attachment__1">
		...
		<input type="password" name="loginPw" class="login-input-box"
			placeholder="비밀번호" /> <input type="submit" class="submit" value="가입" />
	</form>
</div>
</div>
</body>
