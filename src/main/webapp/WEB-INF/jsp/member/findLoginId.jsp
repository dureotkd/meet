...
<body>
	...
	<form action="doFindLoginId" method="POST" class="login-form"
		...
		<input type="text" name="name" class="login-input-box"
			...
			class="login-input-box" placeholder="활동명" />
			<a href="../member/findLoginPw" class="pw">비밀번호를 잊으셨나요?</a>
			 <input type="submit"
			class="submit" value="아이디 찾기" />
	</form>
</div>
